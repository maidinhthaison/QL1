Public Interface IDonHangController
    ...
    Sub Xuly_Get_ChiTiet_DonHang_With_KH_NV_By_ChiNhanh(pbhMa As Integer)

    Sub Xuly_GetAll_DonHang_With_KH_NhanVien_ChiNhanh_By_ChiNhanh(chiNhanhMa As Integer)
